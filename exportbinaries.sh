...
# Debug exports
${godotexec} -path "${PWD}/src" -export-debug "Linux X11" "${PWD}/bin/DIedit32"
${godotexec} -path "${PWD}/src" -export-debug "Windows Desktop" "${PWD}/bin/DIedit.exe"
${godotexec} -path "${PWD}/src" -export-debug "Mac OSX" "${PWD}/bin/Di2Macfat.zip"
${godotexec} -path "${PWD}/src" -export-debug "Android" "${PWD}/bin/DI2.apk"
